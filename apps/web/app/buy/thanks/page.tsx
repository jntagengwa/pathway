  ...
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-4 px-4 py-16 md:py-20">
      ...
      <p className="text-base text-pw-text-muted">
        We’re processing your order via Stripe. You’ll receive an email shortly. You can
        manage your plan in the Nexsteps admin under Billing once your subscription is
        active.
      </p>
      <div className="mt-4 flex gap-3">
        ...
        <a
          href="https://app.pathway.example.com"
