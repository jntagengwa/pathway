...
export default function BuyCancelledPage() {
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-4 px-4 py-16 md:py-20">
      <h1 className="text-3xl font-semibold text-pw-text">Checkout cancelled</h1>
      <p className="text-base text-pw-text-muted">
        Your Stripe checkout was cancelled. You can adjust your selections and try again,
        or contact us if you need help completing your purchase.
      </p>
      <div className="mt-4 flex gap-3">
        ...
        <a
          href="mailto:hello@pathway.app?subject=Need%20help%20with%20Buy%20Now"
