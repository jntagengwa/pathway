...
export const metadata: Metadata = {
  title: "Nexsteps for Charities",
  description:
    "Support charities and non-profit organisations with secure, GDPR-compliant management tools for children and youth programmes.",
};
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 px-4 py-16 md:py-24">
      <div className="flex flex-col gap-4">
        <h1 className="text-4xl font-bold text-pw-text">Nexsteps for Charities</h1>
        <p className="text-lg text-pw-text-muted">
          Support charities and non-profit organisations with secure, GDPR-compliant management
          tools for children and youth programmes. Manage attendance, volunteers, and parent
      ...
      <section className="rounded-xl border border-pw-border bg-white p-6">
        <h2 className="mb-4 text-2xl font-semibold text-pw-text">Perfect for Charities</h2>
        <ul className="flex flex-col gap-3 text-pw-text-muted">
          ...
          <li>• Coordinate volunteers and staff</li>
