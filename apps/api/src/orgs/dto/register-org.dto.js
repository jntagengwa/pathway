...
export const adminDto = z
    ...
    .strict()
    .refine((v) => Boolean(v.userId || (v.email && v.fullName)), "Either userId or (email & fullName) must be provided");
/**
...
export const initialTenantDto = z
    ...
    .strict()
    .refine((v) => (v.create ? Boolean(v.name && v.slug) : true), "name and slug are required when create=true");
/**
