...
describe("PreferencesController", () => {
    ...
    describe("create", () => {
        it("should validate body and call service.create", async () => {
            ...
            expect(service.create).toHaveBeenCalledWith({ ...dto, tenantId }, tenantId);
    ...
    describe("findOne", () => {
        ...
        it("should 400 on invalid uuid", async () => {
            await expect(controller.findOne({ id: "not-a-uuid" }, tenantId)).rejects.toBeInstanceOf(BadRequestException);
    ...
    describe("update", () => {
        it("should validate id + body and call service.update", async () => {
            ...
            const result = await controller.update({ id: basePref.id }, patch, tenantId);
        ...
        it("should 400 when minutes out of range", async () => {
            ...
            await expect(controller.update({ id: basePref.id }, patch, tenantId)).rejects.toBeInstanceOf(BadRequestException);
